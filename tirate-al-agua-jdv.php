              ...
              <tbody>
                ...
                foreach($registros as $registro){ 
                 ...
                 <tr>
                    ...
                    <td width="130" class="txt-redbull-celeste"><?= $registro->CUANTOS_FALTAN_DUO; ?></td>
                    <td width="100" class="txt-redbull-rojo"><?= $registro->CUMPLIMIENTO_MANANTIAL; ?></td>
                    <td width="150" class="txt-redbull-rojo"><?= $registro->CUANTOS_FALTAN_MANANTIAL; ?></td>
                    <td width="100" class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_TOTAL; ?></td>
                  </tr>
                  <?php 
