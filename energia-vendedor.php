              ...
              <table class="table table-spacing mx-auto" style="width: 690px;">
                <thead>
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-rojo-oscuro borde" style="height: 60px;padding-top: 5px;">
                          <div class="text-small">Haz <strong>click</strong> y revisa<br>tus clientes por<br>concretar cob.<br>conjunta</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                      ...
                      <th scope="col" class="transparent" >
                        <div class="bg-azul borde" style="height: 60px;padding-top: 5px;">
                          <div class="text-small">Haz <strong>click</strong> y revisa<br>tus clientes por<br>concretar cob.<br>RedBull</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td style="width: 220px;" class="text-start"><?= $registro->nombre; ?></td>
                      <td style="width: 80px;" class="txt-rojo"><?= $registro->e_cob_conjunta; ?></td>
                      <td style="width: 100px;"><a href="energia-cliente.php?id=<?= $registro->id; ?>&tipo=vendedor" class="txt-rojo"><?= $registro->e_cob_concretar; ?></a></td>
                      <td style="width: 80px;" class="txt-azul"><?= $registro->e_cob_redbull; ?></td>
                      <td style="width: 100px;"><a href="energia-cliente-redbull.php?id=<?= $registro->id; ?>&tipo=vendedor" class="txt-azul"><?= $registro->e_cob_rebull_concretar; ?></a></td>
                    ...
                    <tr class="transparent">
                      ...
                      <td class="bg-rojo-oscuro"><?= $total->e_cob_concretar; ?></td>
                      <td class="bg-azul"><?= $total->e_cob_redbull; ?></td>
                      <td class="bg-azul"><?= $total->e_cob_rebull_concretar; ?></td>
              ...
              <table class="table table-spacing is-mobile w-auto">
                <thead>
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-rojo-oscuro borde" style="height: 60px;">
                          <div class="text-small">Clientes por concretar cob. conjunta</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="bg-azul borde" style="height: 60px;"> 
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-azul borde" style="height: 60px;">
                          <div class="text-small">Clientes por concretar cob. RedBull</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-gris borde" style="height: 60px;">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td><a href="energia-cliente.php?id=<?= $registro->id; ?>&tipo=vendedor" class="txt-rojo"><?= $registro->e_cob_concretar; ?></a></td>
                      <td class="txt-azul"><?= $registro->e_cob_redbull; ?></td>
                      <td><a href="energia-cliente-redbull.php?id=<?= $registro->id; ?>&tipo=vendedor" class="txt-azul"><?= $registro->e_cob_rebull_concretar; ?></a></td>
