              ...
              <tbody>
                ...
                ?>
                 <tr>
                    ...
                    <td style="width: 120px;" class="txt-azul"><?= $distrito->CUMPLIMIENTO_DUO_LN; ?></td>
                    <td style="width: 120px;" class="txt-rojo"><?= $distrito->CUMPLIMIENTO_TORRES; ?></td>
                    <td style="width: 120px;" class="txt-amarillo"><?= $distrito->CUMPLIMIENTO_GUAYACAN; ?></td>
                  </tr>
                <?php } ?>
                  <tr class="bg-verde-oscuro fw-bold">
                    ...
                    <td class="bg-azul"><?= $subtotal->CUMPLIMIENTO_DUO_LN; ?></td>
                    <td class="bg-rojo"><?= $subtotal->CUMPLIMIENTO_TORRES; ?></td>
                    <td class="bg-amarillo"><?= $subtotal->CUMPLIMIENTO_GUAYACAN; ?></td>
                  </tr>
              </tbody>
              <?php } 
            ...
            <table class="table table-spacing totales mx-auto">
              <tbody>
                  <tr class="bg-verde-oscuro">
                    ...
                    <td style="width: 120px;" class="bg-azul"><?= $totales->CUMPLIMIENTO_DUO_LN; ?></td>
                    <td style="width: 120px;" class="bg-rojo"><?= $totales->CUMPLIMIENTO_TORRES; ?></td>
                    <td style="width: 120px;" class="bg-amarillo"><?= $totales->CUMPLIMIENTO_GUAYACAN; ?></td>
                  </tr>
              </tbody>
            </table>
            <?php } ?>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td class="txt-azul"><?= $distrito->CUMPLIMIENTO_DUO_LN; ?></td>
                    <td class="txt-rojo"><?= $distrito->CUMPLIMIENTO_TORRES; ?></td>
                    <td class="txt-amarillo"><?= $distrito->CUMPLIMIENTO_GUAYACAN; ?></td>
                  </tr>
                <?php } ?>
                  <tr class="bg-verde-oscuro fw-bold">
                    <td class="text-start bg-verde-oscuro">Total Zona Norte</td>
            ...
            ?>
                <?php if($totales){ ?>
                  <tr class="bg-verde-oscuro">
                    ...
                    <td class="bg-azul"><?= $totales->CUMPLIMIENTO_DUO_LN; ?></td>
                    <td class="bg-rojo"><?= $totales->CUMPLIMIENTO_TORRES; ?></td>
                    <td class="bg-amarillo"><?= $totales->CUMPLIMIENTO_GUAYACAN; ?></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
