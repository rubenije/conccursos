              ...
              <table class="table table-spacing mx-auto">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td width="150" class="txt-azul"><?= $registro->CUMPLIMIENTO_G1; ?></td>
                      <td width="150" class="txt-celeste"><?= $registro->CUMPLIMIENTO_G2; ?></td>
                      <td width="100" class="txt-rojo"><?= $registro->CUMP_TOTAL; ?></td>
                    ...
                    <tr class="transparent">
                      ...
                      <td class="bg-azul"><?= $total->CUMPLIMIENTO_G1; ?></td>
                      <td class="bg-celeste"><?= $total->CUMPLIMIENTO_G2; ?></td>
                      <td class="bg-rojo"><?= $total->CUMP_TOTAL; ?></td>
                      <td class="bg-rojo">&nbsp;</td>
                    </tr>
                    <?php } ?>
                </tbody>
            ...
            <div class="is-mobile">
                  ...
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde" style="height: 60px;">
                            <div class="space-15"></div>
                            <div class="text-small">CUMP G1</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-celeste borde" style="height: 60px;">
                            <div class="space-15"></div>
                            <div class="text-small">CUMP G2</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                ...
                <tbody style="vertical-align: middle !important;">
                    ...
                    <tr>
                      ...
                      <td class="txt-azul"><?= $registro->CUMPLIMIENTO_G1; ?></td>
                      <td class="txt-celeste"><?= $registro->CUMPLIMIENTO_G2; ?></td>
                      <td class="txt-rojo"><?= $registro->CUMP_TOTAL; ?></td>
