              ...
              <table class="table table-spacing mx-auto">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td width="100" class="txt-redbull-celeste"><?= $registro->CUMPLIMIENTO_DUO; ?></td>
                      <td width="100" class="txt-redbull-celeste"><?= $registro->CUANTOS_FALTAN_DUO; ?></td>
                      <td width="100" class="txt-redbull-rojo"><?= $registro->CUMPLIMIENTO_MANANTIAL; ?></td>
                      <td width="100" class="txt-redbull-rojo"><?= $registro->CUANTOS_FALTAN_MANANTIAL; ?></td>
                      <td width="100"><a href="<?= $table; ?>-al-agua-cliente.php?id=<?= $registro->id; ?>&tipo=vendedor" class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_TOTAL; ?></a></td>
                    </tr>
                    <?php 
                    ...
                    <tr class="transparent">
                      ...
                      <td class="bg-redbull-celeste"><?= $total->CUMPLIMIENTO_DUO; ?></td>
                      <td class="bg-redbull-celeste"><?= $total->CUANTOS_FALTAN_DUO; ?></td>
                      <td class="bg-redbull-rojo"><?= $total->CUMPLIMIENTO_MANANTIAL; ?></td>
                      <td class="bg-redbull-rojo"><?= $total->CUANTOS_FALTAN_MANANTIAL; ?></td>
            ...
            <div class="is-mobile">
                ...
                <tbody style="vertical-align: middle !important;">
                    ...
                    <tr>
                      ...
                      <td class="txt-redbull-celeste"><?= $registro->CUMPLIMIENTO_DUO; ?></td>
                      <td class="txt-redbull-celeste"><?= $registro->CUANTOS_FALTAN_DUO; ?></td>
                      <td class="txt-redbull-rojo"><?= $registro->CUMPLIMIENTO_MANANTIAL; ?></td>
                      <td class="txt-redbull-rojo"><?= $registro->CUANTOS_FALTAN_MANANTIAL; ?></td>
                      <td ><a href="<?= $table; ?>al-agua-cliente.php?id=<?= $registro->id; ?>&tipo=vendedor" class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_TOTAL; ?></a></td>
                    </tr>
                    <?php 
                      $totIngresos += $ingresos;
                      } ?>
