    ...
    <main class="flex-grow-1">
      ...
      <div class="container tablitas">
        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-8 text-center">
              ...
              <thead>
                <tr>
                  ...
                  <th scope="col" class="transparent">
                    <div class="titulo bg-amarillo-claro borde" style="line-height: 15px;">
                      <div class="text-small">Tasa De Uso De Sitio Web<br>(Ingresos Totales)</div>
                    </div>
                  </th>
                  <th scope="col" class="transparent">
                    <div class="titulo bg-amarillo-claro borde">
                      <div class="space-10"></div>
                      ID Únicos
                    </div>
                  </th>
              ...
              <tbody>
                <?php 
                 ...
                 <tr>
                    ...
                    <td style="width: 110px;" class="txt-amarillo-claro"><?= $ingresos; ?></td>
                    <td style="width: 70px;" class="txt-amarillo-claro"><?= $unicos; ?></td>
                ...
                ?>
                  <tr class="bg-verde-oscuro fw-bold">
                    ...
                    <td class="bg-amarillo-claro"><?= $totIngresos; ?></td>
                    <td class="bg-amarillo-claro"><?= $totUnicos; ?></td>
            ...
            <table class="table table-spacing totales mx-auto" style="width: 690px;">
              <tbody>
                  <tr class="bg-verde-oscuro fw-bold">
                    ...
                    <td style="width: 110px;"  class="bg-amarillo-claro"><?= $totFinalIngresos; ?></td>
                    <td style="width: 70px;"  class="bg-amarillo-claro"><?= $totFinalUnicos; ?></td>
              ...
              ?>  
                ...
                <?php 
                  ...
                  <tr>
                    ...
                    <td class="txt-amarillo-claro"><?= $ingresos; ?></td>
                    <td class="txt-amarillo-claro"><?= $unicos; ?></td>
                    <td class="txt-rojo"><?= $distrito->e_cob_conjunta; ?></td>
                    <td class="txt-azul"><?= $distrito->e_cob_redbull; ?></td>
                    <td class="txt-gris"><?= $distrito->e_cupones; ?></td>
                  </tr>
                <?php } 
                    $totFinalIngresos+= $totIngresos;
                    $totFinalUnicos+= $totUnicos;
            ...
            <?php } ?>
                  ...
                  <tr class="bg-verde-oscuro fw-bold">
                    ...
                    <td  class="bg-amarillo-claro"><?= $totFinalIngresos; ?></td>
                    <td  class="bg-amarillo-claro"><?= $totFinalUnicos; ?></td>
          ...
          <div class="col-12 col-lg-2 d-flex justify-content-center align-items-center">
            <img src="assets/img/logo-redbul-v2.png" class="logo-redbull img-fluid is-desktop" alt="">
          </div>
