              ...
              <table class="table table-spacing mx-auto tableDetalles pt-2 pb-3">
                ...
                <tbody style="vertical-align: middle !important;">
                  <?php foreach($detalles as $detalle){ 
                      $class_bilz = ($detalle->COB_BILZ == 'SI') ? 'txt-azul' : 'txt-rojo';
                      $class_pap = ($detalle->COB_PAP == 'SI') ? 'txt-azul' : 'txt-rojo';
                      $class_kem = ($detalle->COB_KEM == 'SI') ? 'txt-azul' : 'txt-rojo';
                      $class_limon = ($detalle->COB_LIMON_SODA == 'SI') ? 'txt-azul' : 'txt-rojo';
                  ?>
                  <tr>
                      ...
                      <td class="<?= $class_bilz; ?>"><?= $detalle->COB_BILZ; ?></td>
                      <td class="<?= $class_pap; ?>"><?= $detalle->COB_PAP; ?></td>
                      <td class="<?= $class_kem; ?>"><?= $detalle->COB_KEM; ?></td>
                      <td class="<?= $class_limon; ?>"><?= $detalle->COB_LIMON_SODA; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
              </table>
