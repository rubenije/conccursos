              ...
              <table class="table table-spacing mx-auto tableDetalles pt-2 pb-3 w-100">
                <thead>
                  <tr style="vertical-align: middle !important;">
                      ...
                      <th scope="col" class="bg-azul borde text-center">VOLUMEN AL DÍA<br>CRISTAL - ESCUDO</th>
                      <th scope="col" class="bg-azul borde text-center">VOLUMEN AL DÍA<br>AGOSTO 2025</th>
                      <th scope="col" class="bg-azul borde text-center">VOLUMEN MES COMPLETO<br>AGOSTO 2025</th>
                  </tr>
                </thead>
                <tbody style="vertical-align: middle !important;">
                  ...
                  <tr>
                      ...
                      <td class="txt-azul"><?= $detalle->VOLUMEN_AL_DIA_CRI_ESC; ?></td>
                      <td class="txt-azul"><?= $detalle->VOLUMEN_AL_DIA_AGOSTO_2025; ?></td>
                      <td class="txt-azul"><?= $detalle->VOLUMEN_MES_COMPLETO_AGOSTO_2025; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
              </table>
