              ...
              <tbody>
                ...
                ?>
                 <tr>
                    ...
                    <td style="width: 120px;" class="txt-azul"><?= $distrito->CUMPLIMIENTO_3_SABORES; ?></td>
                    <td style="width: 120px;" class="txt-rojo"><?= $distrito->CUMPLIMIENTO_LIGHT; ?></td>
                  </tr>
                <?php } ?>
                  <tr class="bg-verde-oscuro fw-bold">
                    ...
                    <td class="bg-azul"><?= $subtotal->CUMPLIMIENTO_3_SABORES; ?></td>
                    <td class="bg-rojo"><?= $subtotal->CUMPLIMIENTO_LIGHT; ?></td>
                  </tr>
              </tbody>
              <?php } 
            ...
            <table class="table table-spacing totales mx-auto">
              <tbody>
                  <tr class="bg-verde-oscuro">
                    ...
                    <td style="width: 120px;" class="bg-azul"><?= $totales->CUMPLIMIENTO_3_SABORES; ?></td>
                    <td style="width: 120px;" class="bg-rojo"><?= $totales->CUMPLIMIENTO_LIGHT; ?></td>
                  </tr>
              </tbody>
            </table>
            <?php } ?>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td class="txt-azul"><?= $distrito->CUMPLIMIENTO_3_SABORES; ?></td>
                    <td class="txt-rojo"><?= $distrito->CUMPLIMIENTO_LIGHT; ?></td>
                  </tr>
                <?php } ?>
                  <tr class="bg-verde-oscuro fw-bold">
                    <td class="text-start bg-verde-oscuro">Total Zona Norte</td>
            ...
            ?>
                <?php if($totales){ ?>
                  <tr class="bg-verde-oscuro">
                    ...
                    <td class="bg-azul"><?= $totales->CUMPLIMIENTO_3_SABORES; ?></td>
                    <td class="bg-rojo"><?= $totales->CUMPLIMIENTO_LIGHT; ?></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
