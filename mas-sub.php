          ...
          <div class="col-12 col-lg-8 text-center">
                ...
                <tr>
                  ...
                  <th scope="col" class="transparent">
                    <div class="titulo bg-azul borde">
                        <div class="space-5"></div>
                        <div class="text-small">CUMP<br>G1</div>
                    </div>
                  </th>
                  <th scope="col" class="transparent">
                    <div class="titulo bg-celeste borde">
                        <div class="space-5"></div>
                        <div class="text-small">CUMP<br>G2</div>
                    </div>
                  </th>
                  <th scope="col" class="transparent">
              ...
              <tbody>
                ...
                ?>
                 <tr>
                    ...
                    <td style="width: 140px;" class="txt-azul"><?= $distrito->CUMPLIMIENTO_G1; ?></td>
                    <td style="width: 140px;" class="txt-celeste"><?= $distrito->CUMPLIMIENTO_G2; ?></td>
                    <td style="width: 100px;" class="txt-rojo"><?= $distrito->CUMP_TOTAL; ?></td>
                  </tr>
                <?php } ?>
                  <tr class="bg-verde-oscuro fw-bold">
                    ...
                    <td class="bg-azul"><?= $subtotal->CUMPLIMIENTO_G1; ?></td>
                    <td class="bg-celeste"><?= $subtotal->CUMPLIMIENTO_G2; ?></td>
                    <td class="bg-rojo"><?= $subtotal->CUMP_TOTAL; ?></td>
                  </tr>
              </tbody>
              <?php } 
            ...
            <table class="table table-spacing totales mx-auto">
              <tbody>
                  <tr class="bg-verde-oscuro">
                    ...
                    <td style="width: 140px;" class="bg-azul"><?= $totales->CUMPLIMIENTO_G1; ?></td>
                    <td style="width: 140px;" class="bg-celeste"><?= $totales->CUMPLIMIENTO_G2; ?></td>
                    <td style="width: 100px;" class="bg-rojo"><?= $totales->CUMP_TOTAL; ?></td>
                  </tr>
              </tbody>
            </table>
            <?php } ?>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td class="txt-azul"><?= $distrito->CUMPLIMIENTO_G1; ?></td>
                    <td class="txt-celeste"><?= $distrito->CUMPLIMIENTO_G2; ?></td>
                    <td class="txt-rojo"><?= $distrito->CUMP_TOTAL; ?></td>
                  </tr>
                <?php } ?>
                  <tr class="bg-verde-oscuro fw-bold">
                    <td class="text-start bg-verde-oscuro">Total Zona Norte</td>
            ...
            <?php if($totales) { ?>
                  <tr class="bg-verde-oscuro">
                    ...
                    <td class="bg-azul"><?= $totales->CUMPLIMIENTO_G1; ?></td>
                    <td class="bg-celeste"><?= $totales->CUMPLIMIENTO_G2; ?></td>
                    <td class="bg-rojo"><?= $totales->CUMP_TOTAL; ?></td>
                  </tr>
            <?php } ?>
              </tbody>
            </table>
            ...
            <!-- END TABLA -->
            <p class="premios ubuntu-bold">REVISA LA INFORMACIÓN DE LOS PREMIOS HACIENDO <a href="assets/pdf/mas.pdf" target="_blank" class="irpdf">CLICK AQUÍ</a></p>
