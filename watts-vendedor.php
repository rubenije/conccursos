              ...
              <table class="table table-spacing mx-auto" style="vertical-align: middle !important;">
                  ...
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde" style="height: 60px;"> 
                            ...
                            <div class="text-small">CUMPLIMIENTO<br>3 SABORES ROTADORES</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde" style="height: 60px;"> 
                            <div class="space-10"></div>
                            <div class="text-small">FALTANTES<br>ROTADORES</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-rojo borde" style="height: 60px;"> 
                            <div class="space-10"></div>
                            <div class="text-small">CUMPLIMIENTO<br>ACELERADOR LIGHT</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-rojo borde" style="height: 60px;"> 
                            <div class="space-10"></div>
                            <div class="text-small">FALTANTES<br>LIGHT</div>
                        </div>
                      </th>
                      <?php }else{  ?>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde" style="height: 60px;"> 
                            <div class="space-10"></div>
                            <div class="text-small">CUMPLIMIENTO<br>VOL SABORES ROTADORES</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-rojo borde" style="height: 60px;"> 
                            <div class="space-10"></div>
                            <div class="text-small">CUMPLIMIENTO<br>VOL ACELERADOR LIGHT</div>
                        </div>
                      </th>
                      <?php } ?>
                      <th scope="col" class="transparent">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <?php if(!$isMayorista){ ?>
                      <td width="120" class="txt-azul"><?= $registro->CUMPLIMIENTO_3_SABORES; ?></td>
                      <td width="100" class="txt-azul"><?= $registro->FALTANTE_3_SABORES_R; ?></td>
                      <td width="120" class="txt-rojo"><?= $registro->CUMPLIMIENTO_LIGHT; ?></td>
                      <td width="100" class="txt-rojo"><?= $registro->FALTANTE_LIGHT; ?></td>
                      <?php }else{  ?>
                      <td width="120" class="txt-azul"><?= $registro->CUMPLIMIENTO_VOL_R; ?></td>
                      <td width="120" class="txt-rojo"><?= $registro->CUMPLIMIENTO_VOL_LIGHT; ?></td>
                      <?php } ?>
                    ...
                    <tr class="transparent">
                      ...
                      <?php if(!$isMayorista){ ?>
                      <td class="bg-azul"><?= $total->CUMPLIMIENTO_3_SABORES; ?></td>
                      <td class="bg-azul"><?= $total->FALTANTE_3_SABORES_R; ?></td>
                      <td class="bg-rojo"><?= $total->CUMPLIMIENTO_LIGHT; ?></td>
                      <td class="bg-rojo"><?= $total->FALTANTE_LIGHT; ?></td>
                      <?php }else{  ?>
                      <td class="bg-azul"><?= $total->CUMPLIMIENTO_VOL_R; ?></td>
                      <td class="bg-rojo"><?= $total->CUMPLIMIENTO_VOL_LIGHT; ?></td>
                      <?php } ?>
            ...
            <div class="is-mobile">
                  ...
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde">
                            <div class="text-small">Cump<br>3 Sabores R</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde">
                      ...
                      <th scope="col" class="transparent">
                        <div class="titulo bg-rojo borde">
                          <div class="text-small">Cump<br>Acelerador Light</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-rojo borde">
                      ...
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde">
                            <div class="text-small">Cump<br>Vol Sabores R</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-rojo borde">
                          <div class="text-small">Cump<br>Vol Acelerador Light</div>
                        </div>
                      </th>
                      <?php } ?>
                      <th scope="col" class="transparent" >
                ...
                <tbody style="vertical-align: middle !important;">
                    ...
                    <tr>
                      ...
                      <?php if(!$isMayorista){ ?>
                      <td class="txt-azul"><?= $registro->CUMPLIMIENTO_3_SABORES; ?></td>
                      <td class="txt-azul"><?= $registro->FALTANTE_3_SABORES_R; ?></td>
                      <td class="txt-rojo"><?= $registro->CUMPLIMIENTO_LIGHT; ?></td>
                      <td class="txt-rojo"><?= $registro->FALTANTE_LIGHT; ?></td>
                      <?php }else{  ?>
                      <td class="txt-azul"><?= $registro->CUMPLIMIENTO_VOL_R; ?></td>
                      <td class="txt-rojo"><?= $registro->CUMPLIMIENTO_VOL_LIGHT; ?></td>
                      <?php } ?>
