              ...
              <table class="table table-spacing mx-auto tableDetalles pt-2 pb-3">
                <thead>
                  <tr style="vertical-align: middle !important;">
                      ...
                      <th scope="col" class="bg-redbull-celeste borde text-center">Cob Catun 16</th>
                      <th scope="col" class="bg-redbull-celeste borde text-center">Cob Catun 25</th>
                      <th scope="col" class="bg-redbull-azul borde text-center">Cob Manantial</th>
                      
                  </tr>
                </thead>
                <tbody style="vertical-align: middle !important;">
                  <?php foreach($detalles as $detalle){ 
                      $class_16 = ($detalle->COB_CATUN_16 == 'SI') ? 'txt-redbull-celeste' : 'txt-redbull-rojo';
                      $class_25 = ($detalle->COB_CATUN_25 == 'SI') ? 'txt-redbull-celeste' : 'txt-redbull-rojo';
                      $class_3 = ($detalle->COB_MANANTIAL_3 == 'SI') ? 'txt-redbull-azul' : 'txt-redbull-rojo';
                  ?>
                  <tr>
                      ...
                      <td class="<?= $class_3; ?>"><?= $detalle->COB_MANANTIAL_3; ?></td>
