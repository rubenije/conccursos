      ...
      <div class="container tablitas">
        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-8 text-center">
            <img src="assets/img/cliente-verde.png" class="img-fluid cliente-verde" alt="Cliente Verde">
            ...
            <div class="is-desktop">
              <table class="table table-spacing mx-auto" style="width: 500px;">
                ...
                <tbody>
                  ...
                  <tr>
                      <td class="txt-verde-oscuro"><?= $detalle->id; ?></td>
                      <td class="txt-verde-oscuro"><?= $detalle->sector; ?></td>
                      <td class="text-start txt-verde-oscuro"><?= $detalle->razon; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
              </table>
