	...
	if(file_exists($file_csv)){
		...
		if(is_array($datas) && !empty($datas)){
			...
			foreach ($datas as $data) { 
				...
				$post['HL_AL_DIA_MES_EN_CURSO'] 				= $data['HL_AL_DIA_MES_EN_CURSO'] ?? "";
				$post['HL_VS_AA_AL_DIA'] 		    			= $data['HL_VS_AA_AL_DIA'] ?? "";
				$post['HL_AA_AL_DIA_MES_EN_CURSO'] 				= $data['HL_AA_AL_DIA_MES_EN_CURSO'] ?? "";
				$post['HL_FALTANTE_PARA_100_AA_MES_EN_CURSO'] 	= $data['HL_FALTANTE_PARA_100%_AA_MES_EN_CURSO'] ?? "";
