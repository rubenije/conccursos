          ...
          <div class="col-12 col-lg-8 text-center">
                    ...
                    <th scope="col" class="transparent">
                      ...
                      <th scope="col" class="transparent">
                        <div class="titulo bg-rojo borde"> 
                            <div class="space-5"></div>
                            <div class="text-small">CUMPLIMIENTO<br>2 DE 1LT + 750</div>
                        </div>
                      </th>
                      <?php }else{ ?>
                      <th scope="col" class="transparent">
              ...
              <tbody>
                ...
                foreach($registros as $registro){ 
                 ...
                 <tr>
                    ...
                    <td width="120" class="txt-rojo"><?= $registro->CUMPLIMIENTO_ACELERADOR_750_1LT; ?></td>
                    <?php }else{ ?>
            ...
            <thead>
              <tr>
                  ...
                  <th scope="col" class="transparent">
                    <div class="titulo bg-rojo borde"> 
                      <div class="text-small">Cump<br>Acelerador 2 de 1LT + 750</div>
                    </div>
                  </th>
                  <?php }else{ ?>
                  <th scope="col" class="transparent">
