              ...
              <table class="table table-spacing mx-auto tableDetalles pt-2 pb-3">
                <thead>
                  <tr style="vertical-align: middle !important;">
                      ...
                      <th scope="col" class="bg-amarillo borde text-center">HL AL DIA</th>
                      <th scope="col" class="bg-amarillo borde text-center">VS AA AL DIA</th>
                      <th scope="col" class="bg-verde-claro borde text-center">TOTAL HL MES ANTERIOR</th>
                      <th scope="col" class="bg-verde-claro borde text-center">HL PARA 100% AA</th>
                  </tr>
                </thead>
                <tbody style="vertical-align: middle !important;">
                  <?php foreach($detalles as $detalle){ 
                      $class_1 = ($detalle->HL_AL_DIA_MES_EN_CURSO == 'SI') ? 'txt-azul' : 'txt-azul';
                      $class_2 = ($detalle->HL_VS_AA_AL_DIA == 'SI') ? 'txt-azul' : 'txt-azul';
                      $class_3 = ($detalle->HL_AA_AL_DIA_MES_EN_CURSO == 'SI') ? 'txt-azul' : 'txt-azul';
                      $class_4 = ($detalle->HL_FALTANTE_PARA_100_AA_MES_EN_CURSO == 'SI') ? 'txt-azul' : 'txt-azul';
                  ?>
                  <tr>
                      ...
                      <td class="<?= $class_1; ?>"><?= $detalle->HL_AL_DIA_MES_EN_CURSO; ?></td>
                      <td class="<?= $class_2; ?>"><?= $detalle->HL_VS_AA_AL_DIA; ?></td>
                      <td class="<?= $class_3; ?>"><?= $detalle->HL_AA_AL_DIA_MES_EN_CURSO; ?></td>
                      <td class="<?= $class_4; ?>"><?= $detalle->HL_FALTANTE_PARA_100_AA_MES_EN_CURSO; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
              </table>
