              ...
              <table class="table table-spacing mx-auto">
                  ...
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-azul borde" style="height: 60px;padding-top: 0px;"> 
                          <div class="titulo">
                            <div class="space-10"></div>
                            <div class="text-small">CUMP COBERTURA<br>SABORES CORE</div>
                          </div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td width="80" class="txt-redbull-amarillo"><?= $ingresos; ?></td>
                      <td width="120" class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_SABORES_COBERTURA; ?></td>
                      <td width="120" class="txt-redbull-azul"><?= $registro->CLIENTES_FALTANTE; ?></td>
                    ...
                    <tr class="transparent">
                      ...
                      <td class="bg-redbull-azul"><?= $total->CUMPLIMIENTO_SABORES_COBERTURA; ?></td>
                      <td class="bg-redbull-azul"><?= $total->CLIENTES_FALTANTE; ?></td>
            ...
            <div class="is-mobile">
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-azul borde" style="height: 60px;">
                          <div class="titulo">
                            ...
                            <div class="text-small">CUMP COB<br>SABORES CORE</div>
                          </div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-azul borde" style="height: 60px;">
                          <div class="titulo">
                            <div class="space-5"></div>
                            <div class="text-small">CLIENTES FALTANTES<br></div>
                          </div>
                        </div>
                      </th>
                      <th scope="col" class="transparent" >
                ...
                <tbody style="vertical-align: middle !important;">
                    ...
                    <tr>
                      ...
                      <td class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_SABORES_COBERTURA; ?></td>
                      <td class="txt-redbull-azul"><?= $registro->CLIENTES_FALTANTE; ?></td>
