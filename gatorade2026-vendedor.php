              ...
              <table class="table table-spacing mx-auto" style="vertical-align: middle !important;">
                  ...
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde" style="height: 60px;"> 
                            ...
                            <div class="text-small">CUMPLIMIENTO<br>HORIZONTAL</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde" style="height: 60px;"> 
                            <div class="space-10"></div>
                            <div class="text-small">FALTANTE COBERTURA<br>HORIZONTAL</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-rojo borde" style="height: 60px;"> 
                            <div class="space-10"></div>
                            <div class="text-small">CUMPLIMIENTO<br>ACELERADOR 750 1LT</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-rojo borde" style="height: 60px;"> 
                            <div class="space-10"></div>
                            <div class="text-small">FALTANTES<br>ACELERADOR</div>
                        </div>
                      </th>
                      <?php }else{  ?>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde" style="height: 60px;"> 
                            <div class="space-10"></div>
                            <div class="text-small">CUMPLIMIENTO<br>VOL TOTAL</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-rojo borde" style="height: 60px;"> 
                            <div class="space-10"></div>
                            <div class="text-small">CUMPLIMIENTO<br>VOL 750 (ACELERADOR)</div>
                        </div>
                      </th>
                      <?php } ?>
                      <th scope="col" class="transparent">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <?php if(!$isMayorista){ ?>
                      <td width="100" class="txt-azul"><?= $registro->CUMPLIMIENTO_HORIZONTAL; ?></td>
                      <td width="100" class="txt-azul"><?= $registro->FALTANTE_HORIZONTAL; ?></td>
                      <td width="100" class="txt-rojo"><?= $registro->CUMPLIMIENTO_ACELERADOR_750_1LT; ?></td>
                      <td width="100" class="txt-rojo"><?= $registro->FALTANTE_ACELERADOR; ?></td>
                      <?php }else{  ?>
                      <td width="100" class="txt-azul"><?= $registro->CUMPLIMIENTO_VOL_GATORADE; ?></td>
                      <td width="100" class="txt-rojo"><?= $registro->CUMPLIMIENTO_VOL_ACELERADOR; ?></td>
                      <?php } ?>
                    ...
                    <tr class="transparent">
                      ...
                      <?php if(!$isMayorista){ ?>
                      <td class="bg-azul"><?= $total->CUMPLIMIENTO_HORIZONTAL; ?></td>
                      <td class="bg-azul"><?= $total->FALTANTE_HORIZONTAL; ?></td>
                      <td class="bg-rojo"><?= $total->CUMPLIMIENTO_ACELERADOR_750_1LT; ?></td>
                      <td class="bg-rojo"><?= $total->FALTANTE_ACELERADOR; ?></td>
                      <?php }else{  ?>
                      <td class="bg-azul"><?= $total->CUMPLIMIENTO_VOL_GATORADE; ?></td>
                      <td class="bg-rojo"><?= $total->CUMPLIMIENTO_VOL_ACELERADOR; ?></td>
                      <?php } ?>
            ...
            <div class="is-mobile">
                  ...
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde">
                            <div class="text-small">Cump<br>Horizontal</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde">
                            <div class="text-small">Faltante Cob<br>Horizontal</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-rojo borde">
                          <div class="text-small">Cump<br>Acelerador 750 1LT</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-rojo borde">
                      ...
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde">
                            <div class="text-small">Cump<br>Vol Total</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-rojo borde">
                          <div class="text-small">Cump<br>Vol 750 (Acelerador)</div>
                        </div>
                      </th>
                      <?php } ?>
                      <th scope="col" class="transparent" >
                ...
                <tbody style="vertical-align: middle !important;">
                    ...
                    <tr>
                      ...
                      <?php if(!$isMayorista){ ?>
                      <td class="txt-azul"><?= $registro->CUMPLIMIENTO_HORIZONTAL; ?></td>
                      <td class="txt-azul"><?= $registro->FALTANTE_HORIZONTAL; ?></td>
                      <td class="txt-rojo"><?= $registro->CUMPLIMIENTO_ACELERADOR_750_1LT; ?></td>
                      <td class="txt-rojo"><?= $registro->FALTANTE_ACELERADOR; ?></td>
                      <?php }else{  ?>
                      <td class="txt-azul"><?= $registro->CUMPLIMIENTO_VOL_GATORADE; ?></td>
                      <td class="txt-rojo"><?= $registro->CUMPLIMIENTO_VOL_ACELERADOR; ?></td>
                      <?php } ?>
                    ...
                    <tr class="transparent">
                      ...
                      <?php }else{  
                        $colspan = 4;
                      ?>
                      <td class="bg-azul"><?= $total->CUMPLIMIENTO_VOL_TOTAL; ?></td>
                      <td class="bg-rojo"><?= $total->CUMPLIMIENTO_VOL_ACELERADOR; ?></td>
                      <?php } ?>
                    ...
                    <?php } ?>
                    <tr class="transparent">
                      <td colspan="<?= $colspan; ?>" class="transparent" style="border: none;"></td>
                      <td class="bg-rojo">
                        <div class="text-small">
