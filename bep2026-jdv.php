                    ...
                    <th scope="col" class="transparent">
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-azul borde" style="height: 60px;padding-top: 0px;"> 
                          <div class="titulo">
                            <div class="space-10"></div>
                            <div class="text-small">CUMPLIMENTO VOL<br>BEP</div>
                          </div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
              ...
              <tbody>
                ...
                foreach($registros as $registro){ 
                 ...
                 <tr>
                    ...
                    <?php if($isMayorista){ ?>
                    <td width="150" class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_VOL_BEP; ?></td>
                    <td width="150" class="txt-redbull-rojo"><?= $registro->FALTANTE_VOL_BEP; ?></td>
                    <?php }else{ ?>
                    <td width="150" class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_CONC_BEP; ?></td>
                    <td width="150" class="txt-redbull-rojo"><?= $registro->FALTANTE_CONC_BEP; ?></td>
                    <?php } ?>
                  </tr>
                  <?php 
