              ...
              <table class="table table-spacing mx-auto">
                  ...
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-celeste borde" style="height: 60px;padding-top: 0px;"> 
                          <div class="titulo">
                            <div class="space-10"></div>
                            <div class="text-small">CLIENTES POR CONCRETAR 250</div>
                          </div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-rojo borde" style="height: 60px;padding-top: 0px;"> 
                          <div class="titulo">
                            <div class="space-10"></div>
                            <div class="text-small">CLIENTES POR CONCRETAR 3 SKUS</div>
                          </div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-azul borde" style="height: 60px;padding-top: 10px;">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td width="100" class="txt-redbull-celeste"><?= $registro->cumplimiento_250; ?></td>
                      <td width="100" class="txt-redbull-celeste"><?= $registro->cuantos_faltan_250; ?></td>
                      <td width="100" class="txt-redbull-rojo"><?= $registro->cumplimiento_3_skus; ?></td>
                      <td width="100" class="txt-redbull-rojo"><?= $registro->cuantos_faltan_3_skus; ?></td>
                      <td width="100"><a href="<?= $table; ?>-cliente.php?id=<?= $registro->id; ?>&tipo=vendedor" class="txt-redbull-azul"><?= $registro->cumplimiento_total; ?></a></td>
                    </tr>
                    <?php 
                    ...
                    <tr class="transparent">
                      ...
                      <td class="bg-redbull-celeste"><?= $total->cumplimiento_250; ?></td>
                      <td class="bg-redbull-celeste"><?= $total->cuantos_faltan_250; ?></td>
                      <td class="bg-redbull-rojo"><?= $total->cumplimiento_3_skus; ?></td>
                      <td class="bg-redbull-rojo"><?= $total->cuantos_faltan_3_skus; ?></td>
            ...
            <div class="is-mobile">
                  ...
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-celeste borde" style="height: 60px;">
                          <div class="titulo">
                            <div class="space-5"></div>
                            <div class="text-small">CLIENTES X CONCRETAR 250</div>
                          </div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-rojo borde" style="height: 60px;">
                          <div class="space-5"></div>
                          <div class="text-small">CLIENTES X CONCRETAR 3 SKUS</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent" >
                ...
                <tbody style="vertical-align: middle !important;">
                    ...
                    <tr>
                      ...
                      <td class="txt-redbull-celeste"><?= $registro->cumplimiento_250; ?></td>
                      <td class="txt-redbull-celeste"><?= $registro->cuantos_faltan_250; ?></td>
                      <td class="txt-redbull-rojo"><?= $registro->cumplimiento_3_skus; ?></td>
                      <td class="txt-redbull-rojo"><?= $registro->cuantos_faltan_3_skus; ?></td>
                      <td ><a href="<?= $table; ?>-cliente.php?id=<?= $registro->id; ?>&tipo=vendedor" class="txt-redbull-azul"><?= $registro->cumplimiento_total; ?></a></td>
                    </tr>
                    <?php 
                      $totIngresos += $ingresos;
                      } ?>
