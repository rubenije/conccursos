              ...
              <table class="table table-spacing mx-auto tableDetalles pt-2 pb-3">
                <thead>
                  <tr style="vertical-align: middle !important;">
                      ...
                      <th scope="col" class="bg-azul borde text-center">Calafate</th>
                      <th scope="col" class="bg-azul borde text-center">Torobayo</th>
                      <th scope="col" class="bg-rojo borde text-center">TDP</th>
                      <th scope="col" class="bg-amarillo borde text-center">Guayacan</th>
                  </tr>
                </thead>
                <tbody style="vertical-align: middle !important;">
                  <?php foreach($detalles as $detalle){ 
                      $class_calafate = ($detalle->COB_CALAFATE_500 == 'SI') ? 'txt-azul' : 'txt-rojo';
                      $class_torobayo = ($detalle->COB_TOROBAYO_500 == 'SI') ? 'txt-azul' : 'txt-rojo';
                      $class_tdp = ($detalle->COB_TORRES_PAINE_500 == 'SI') ? 'txt-azul' : 'txt-rojo';
                      $class_papaya = ($detalle->COB_GUAYACAN_PAPAYA_500 == 'SI') ? 'txt-azul' : 'txt-rojo';
                  ?>
                  <tr>
                      ...
                      <td class="<?= $class_calafate; ?>"><?= $detalle->COB_CALAFATE_500; ?></td>
                      <td class="<?= $class_torobayo; ?>"><?= $detalle->COB_TOROBAYO_500; ?></td>
                      <td class="<?= $class_tdp; ?>"><?= $detalle->COB_TORRES_PAINE_500; ?></td>
                      <td class="<?= $class_papaya; ?>"><?= $detalle->COB_GUAYACAN_PAPAYA_500; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
              </table>
