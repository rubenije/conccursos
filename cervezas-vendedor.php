              ...
              <table class="table table-spacing mx-auto">
                  ...
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-azul borde" style="height: 60px;padding-top: 0px;"> 
                          <div class="titulo">
                            <div class="space-10"></div>
                            <div class="text-small">CUMP VOLUMEN<br>CRISTAL - ESCUDO</div>
                          </div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-azul borde" style="height: 60px;padding-top: 0px;"> 
                          <div class="titulo">
                            <div class="space-10"></div>
                            <div class="text-small">HL<br>FALTANTES</div>
                          </div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td width="100" class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_VOLUMEN_CRIS_ESC; ?></td>
                      <td width="100" class="txt-redbull-azul"><?= $registro->HL_FALTANTE; ?></td>
                    ...
                    <tr class="transparent">
                      ...
                      <td class="bg-redbull-azul"><?= $total->CUMPLIMIENTO_VOLUMEN_CRIS_ESC; ?></td>
                      <td class="bg-redbull-azul"><?= $total->HL_FALTANTE; ?></td>
            ...
            <div class="is-mobile">
                ...
                <tbody style="vertical-align: middle !important;">
                    ...
                    <tr>
                      ...
                      <td class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_VOLUMEN_CRIS_ESC; ?></td>
                      <td class="txt-redbull-azul"><?= $registro->HL_FALTANTE; ?></td>
