            ...
            <table class="table table-striped" style="font-size: 12px;">
              ...
              <tbody>
                <?php foreach ($todos as $todo) { 
                  $giros_totales = $objInforme->getGirosTotales($todo->cliente_id);
                  $giros_realizados = $objInforme->getGirosRealizados($todo->cliente_id);
                

                  $saldo = $giros_totales - $giros_realizados;

                  if($giros_realizados > $giros_totales){
                    $giros_realizados = $giros_totales;
                    $saldo = 0;
                  }
                  $factura = new factura();
                ...
                <tr>
                  ...
                  <td><?= $todo->clie_nombre; ?></td>
                  <td><?= $todo->clie_distrito; ?></td>
                  <td>
                    <?php foreach($facturas as $factura){ ?>
                      <?= $factura->fact_numero; ?><br>
                    <?php } ?>
                  </td>
                  <td class="text-center"><?= $giros_totales; ?></td>
                  <td class="text-center"><?= $giros_realizados; ?></td>
