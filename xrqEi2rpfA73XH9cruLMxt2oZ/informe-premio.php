  ...
  <body>
    <div class="container-fluid">
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse justify-content-md-center" id="navbarNav">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="informe-premio.php">PREMIOS</a>
                  </li>
                  <li class="nav-item">
      ...
      <div class="container-fluid pt-5">
        <div class="row">
          <div class="col-12 col-md-8 m-auto pt-4">
            <h4>Listado de Ganadores <a href="#;" class="btn btn-primary float-end lg-vermas">Ver Más +</a></h4>
              ...
              <table class="table table-striped" style="font-size: 12px;">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $ganador->clie_vendedor; ?></td>
                    <td><?= $ganador->fact_numero; ?></td>
                    <!-- <td><?= str_replace(' ', '<br>', $ganador->clie_fecha); ?></td>-->
                    <td><?= $ganador->clie_fecha; ?></td>
