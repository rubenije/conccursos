          ...
          <div class="col-12 col-lg-8 text-center">
              ...
              <tbody>
                ...
                ?>
                 <tr>
                    ...
                    <td style="width: 140px;" class="txt-azul"><?= $distrito->CUMPLIMIENTO_DUO; ?></td>
                    <td style="width: 140px;" class="txt-celeste"><?= $distrito->CUMPLIMIENTO_MANANTIAL; ?></td>
                  </tr>
                <?php } ?>
                  <tr class="bg-verde-oscuro fw-bold">
                    ...
                    <td class="bg-azul"><?= $subtotal->CUMPLIMIENTO_DUO; ?></td>
                    <td class="bg-celeste"><?= $subtotal->CUMPLIMIENTO_MANANTIAL; ?></td>
                  </tr>
              </tbody>
              <?php } 
            ...
            <table class="table table-spacing totales mx-auto">
              <tbody>
                  <tr class="bg-verde-oscuro">
                    ...
                    <td style="width: 140px;" class="bg-azul"><?= $totales->CUMPLIMIENTO_DUO; ?></td>
                    <td style="width: 140px;" class="bg-celeste"><?= $totales->CUMPLIMIENTO_MANANTIAL; ?></td>
                  </tr>
              </tbody>
            </table>
            <?php } ?>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td class="txt-azul"><?= $distrito->CUMPLIMIENTO_DUO; ?></td>
                    <td class="txt-celeste"><?= $distrito->CUMPLIMIENTO_MANANTIAL; ?></td>
                  </tr>
                <?php } ?>
                  <tr class="bg-verde-oscuro fw-bold">
                    <td class="text-start bg-verde-oscuro">Total Zona Norte</td>
            ...
            <?php if($totales) { ?>
                  <tr class="bg-verde-oscuro">
                    ...
                    <td class="bg-azul"><?= $totales->CUMPLIMIENTO_DUO; ?></td>
                    <td class="bg-celeste"><?= $totales->CUMPLIMIENTO_MANANTIAL; ?></td>
                  </tr>
            <?php } ?>
              </tbody>
            </table>
