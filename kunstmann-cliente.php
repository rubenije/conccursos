              ...
              <table class="table table-spacing mx-auto tableDetalles pt-2 pb-3 w-100">
                <thead>
                  <tr style="vertical-align: middle !important;">
                      ...
                      <th scope="col" class="bg-azul borde text-center">VOL</th>
                      <th scope="col" class="bg-azul borde text-center">VOL<br>AA</th>
                  </tr>
                </thead>
                <tbody style="vertical-align: middle !important;">
                  ...
                  <tr>
                      ...
                      <td class="txt-azul"><?= $detalle->VOL; ?></td>
                      <td class="txt-azul"><?= $detalle->VOL_AA; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
              </table>
