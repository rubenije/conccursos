      ...
      <div class="container tablitas">
        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-8 text-center">
              ...
              <thead>
                <tr>
                    <th scope="col" class="transparent">
                      <div class="titulo bg-verde-oscuro borde text-center">
                    ...
                    <th scope="col" class="transparent">
                        <div class="bg-redbull-amarillo borde" style="height: 50px;padding-top: 0px;"> 
                          <div class="titulo">
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-celeste borde" style="height: 50px;padding-top: 0px;"> 
                          <div class="titulo">
                            <div class="space-5"></div>
                            <div class="text-small">CUMP 250<br>"ROMBO"</div>
                          </div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-rojo borde" style="height: 50px;padding-top: 0px;"> 
                          <div class="titulo">
                            <div class="space-5"></div>
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-azul borde" style="height: 50px;padding-top: 0px;">
                          <div class="titulo">
                            <div class="space-5"></div>
                              <div class="text-small">CUMP<br>PONDERADO</div>
                            </div>
                          </div>
                        </div>
                      </th>
              ...
              <tbody>
                ...
                foreach($registros as $registro){ 
                 ...
                 <tr>
                    ...
                    <td width="150" class="txt-redbull-celeste"><?= $registro->CUMPLIMIENTO_250_ROMBO; ?></td>
                    <td width="150" class="txt-redbull-rojo"><?= $registro->CUMPLIMIENTO_EDITIONS; ?></td>
                    <td width="150" class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_PONDERADO; ?></td>
                  </tr>
                  <?php 
            ...
            <!-- END TABLA -->
            <p class="premios ubuntu-bold">REVISA LA INFORMACIÓN DE LOS PREMIOS HACIENDO <a href="assets/pdf/redbull.pdf" target="_blank" class="irpdf">CLICK AQUÍ</a></p>
          </div>
          <div class="col-12 col-lg-2 text-center is-desktop">
