	...
	if(file_exists($file_csv)){
		...
		if(is_array($datas) && !empty($datas)){
			...
			foreach ($datas as $data) { 
				...
				$post['CUMPLIMIENTO_G1'] 			= $data['CUMPLIMIENTO_G1'] ?? "";
				$post['CUANTOS_FALTAN_G1'] 			= $data['CUANTOS_FALTAN_G1'] ?? "";
				$post['CUMPLIMIENTO_G2'] 			= $data['CUMPLIMIENTO_G2'] ?? "";
				$post['CUANTOS_FALTAN_G2'] 			= $data['CUANTOS_FALTAN_G2'] ?? "";
