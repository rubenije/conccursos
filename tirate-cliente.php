              ...
              <table class="table table-spacing mx-auto tableDetalles pt-2 pb-3">
                <thead>
                  <tr style="vertical-align: middle !important;">
                      ...
                      <th scope="col" class="bg-redbull-azul borde text-center">Cob Catun 16</th>
                      <th scope="col" class="bg-redbull-azul borde text-center">Cob Catun 25</th>
                      <th scope="col" class="bg-redbull-celeste borde text-center">Cob <div class="is-desktop">Manantial 30</div><div class="is-mobile">Man 30</div></th>
                      <th scope="col" class="bg-redbull-celeste borde text-center">Cob <div class="is-desktop">Manantial 15</div><div class="is-mobile">Man 15</div></th>
                  </tr>
                </thead>
                <tbody style="vertical-align: middle !important;">
                  <?php foreach($detalles as $detalle){ 
                      $class_16 = ($detalle->COB_CATUN_16 == 'SI') ? 'txt-redbull-azul' : 'txt-redbull-rojo';
                      $class_25 = ($detalle->COB_CATUN_25 == 'SI') ? 'txt-redbull-azul' : 'txt-redbull-rojo';
                      $class_30 = ($detalle->COB_MANANTIAL_30 == 'SI') ? 'txt-redbull-celeste' : 'txt-redbull-rojo';
                      $class_15 = ($detalle->COB_MANANTIAL_15 == 'SI') ? 'txt-redbull-celeste' : 'txt-redbull-rojo';
                  ?>
                  <tr>
                      ...
                      <td class="<?= $class_16; ?>"><?= $detalle->COB_CATUN_16; ?></td>
                      <td class="<?= $class_25; ?>"><?= $detalle->COB_CATUN_25; ?></td>
                      <td class="<?= $class_30; ?>"><?= $detalle->COB_MANANTIAL_30; ?></td>
                      <td class="<?= $class_15; ?>"><?= $detalle->COB_MANANTIAL_15; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
              </table>
