        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-8 text-center">
              ...
              <tbody>
                ...
                ?>
                 <tr>
                    ...
                    <td style="width: 120px;" class="txt-redbull-celeste"><?= $distrito->CUMPLIMIENTO_250_ROMBO; ?></td>
                    <td style="width: 120px;" class="txt-redbull-rojo"><?= $distrito->CUMPLIMIENTO_EDITIONS; ?></td>
                    <td style="width: 120px;" class="txt-redbull-azul"><?= $distrito->CUMPLIMIENTO_PONDERADO; ?></td>
                  </tr>
                <?php } ?>
                  <tr class="bg-verde-oscuro fw-bold">
                    ...
                    <td class="bg-redbull-celeste"><?= $subtotal->CUMPLIMIENTO_250_ROMBO; ?></td>
                    <td class="bg-redbull-rojo"><?= $subtotal->CUMPLIMIENTO_EDITIONS; ?></td>
                    <td class="bg-redbull-azul"><?= $subtotal->CUMPLIMIENTO_PONDERADO; ?></td>
                  </tr>
              </tbody>
              <?php } 
            ...
            <table class="table table-spacing mx-auto">
              <tbody>
                  <tr class="fw-bold">
                    <td style="width: 182px;" class="text-start bg-verde-oscuro">Total General</td>
                    ...
                    <td style="width: 120px;" class="bg-redbull-celeste"><?= $totales->CUMPLIMIENTO_250_ROMBO; ?></td>
                    <td style="width: 120px;" class="bg-redbull-rojo"><?= $totales->CUMPLIMIENTO_EDITIONS; ?></td>
                    <td style="width: 120px;" class="bg-redbull-azul"><?= $totales->CUMPLIMIENTO_PONDERADO; ?></td>
                  </tr>
              </tbody>
            </table>
            <?php } ?>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td class="txt-redbull-celeste"><?= $distrito->CUMPLIMIENTO_250_ROMBO; ?></td>
                    <td class="txt-redbull-rojo"><?= $distrito->CUMPLIMIENTO_EDITIONS; ?></td>
                    <td class="txt-redbull-azul"><?= $distrito->CUMPLIMIENTO_PONDERADO; ?></td>
                  </tr>
                <?php } ?>
                  <tr class="bg-verde-oscuro fw-bold">
                    <td class="text-start bg-verde-oscuro">Total Zona Norte</td>
            ...
            ?>
                <?php if($totales){ ?>
                  <tr class="bg-verde-oscuro">
                    ...
                    <td class="bg-redbull-celeste"><?= $totales->CUMPLIMIENTO_250_ROMBO; ?></td>
                    <td class="bg-redbull-rojo"><?= $totales->CUMPLIMIENTO_EDITIONS; ?></td>
                    <td class="bg-redbull-azul"><?= $totales->CUMPLIMIENTO_PONDERADO; ?></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
