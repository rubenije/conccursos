          ...
          <div class="col-12 col-lg-8 text-center">
              ...
              <tbody>
                ...
                ?>
                 <tr>
                    ...
                    <td style="width: 120px;" class="txt-redbull-rojo"><?= $distrito->CUMPLIMIENTO_MANANTIAL; ?></td>
                ...
                <?php } ?>
                  <tr class="bg-verde-oscuro fw-bold">
                    ...
                    <td class="bg-redbull-rojo"><?= $subtotal->CUMPLIMIENTO_MANANTIAL; ?></td>
            ...
            <table class="table table-spacing totales mx-auto">
              <tbody>
                  <tr class="bg-verde-oscuro">
                    ...
                    <td style="width: 120px;" class="bg-redbull-celeste"><?= $distrito->CUMPLIMIENTO_DUO; ?></td>
                    <td style="width: 120px;" class="bg-redbull-rojo"><?= $distrito->CUMPLIMIENTO_MANANTIAL; ?></td>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td class="txt-redbull-rojo"><?= $distrito->CUMPLIMIENTO_MANANTIAL; ?></td>
            ...
            ?>
                  ...
                  <tr class="bg-verde-oscuro">
                    ...
                    <td class="bg-redbull-rojo"><?= $totales->CUMPLIMIENTO_MANANTIAL; ?></td>
