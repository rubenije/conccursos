          ...
          <div class="col-12 col-md-4">
            <div class="mb-3">
              ...
              <select id="filtroGrupo" class="form-select w-auto mx-auto">
                ...
                <?php
                  $grupos = array_unique(array_map(fn($d) => $d->GRUPO, $detalles));
                  sort($grupos);
              ...
              <table class="table table-spacing mx-auto tableDetalles pt-2 pb-3 w-100">
                <thead>
                  <tr style="vertical-align: middle !important;">
                      ...
                      <th scope="col" class="bg-limon borde text-center">LIMÓN SODA</th>
                ...
                <tbody style="vertical-align: middle !important;">
                  ...
                  <tr>
                      ...
                      <td class="txt-verde-oscuro"><?= $detalle->GRUPO; ?></td>
                      <td class="txt-azul"><?= $detalle->BILZ; ?></td>
                      <td class="txt-azul"><?= $detalle->PAP; ?></td>
                      <td class="txt-azul"><?= $detalle->KEM; ?></td>
                      <td class="txt-azul"><?= $detalle->LIMON_SODA; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
              </table>
    ...
    <script>
      $(document).ready(function () {
        ...
        $('#filtroGrupo').on('change', function () {
          tabla.column(3).search($(this).val());
          tabla.draw();
        });
