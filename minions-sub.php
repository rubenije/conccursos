        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-8 text-center">
            ...
            <table class="table table-spacing mx-auto" style="width: 530px;">
              ...
              <tbody>
                <?php foreach($distritos as $distrito){ ?>
                 <tr>
                    <td style="width: 190px;" class="text-start">
                    ...
                    <td style="width: 100px;" class="txt-verde-oscuro fw-bold"><?= $distrito->m_cupones; ?></td>
                  </tr>
                <?php } ?>
            ...
            <table class="table table-spacing totales mx-auto" style="width: 530px;">
              <tbody>
                  <tr class="bg-verde-oscuro fw-bold">
                    <td style="width: 190px;" class="text-start bg-verde-oscuro">Total General</td>
                    <td style="width: 120px;" class="bg-rojo"><?= $totales->m_cob_conjunta; ?></td>
                    <td style="width: 120px;" class="bg-verde"><?= $totales->m_cob_nectar; ?></td>
                    <td style="width: 100px;" class="bg-verde-oscuro"><?= $totales->m_cupones; ?></td>
                  </tr>
              </tbody>
            </table>
            </div>
                ...
                <tr>
                  ...
                  <th scope="col" class="transparent">
                      <div class="titulo bg-verde borde">
                        <div class="text-small">Cobertura<br>Néctar</div>
                      </div>
                  </th>
                  <th scope="col" class="transparent">
                    <div class="titulo bg-verde-oscuro borde">
