              ...
              <table class="table table-spacing mx-auto tableDetalles pt-2 pb-3">
                <thead>
                  <tr style="vertical-align: middle !important;">
                      <th scope="col" class="bg-verde-oscuro borde text-center" style="height: 30px;">ID</th>
                      <th scope="col" class="bg-verde-oscuro borde">Sector</th>
                      <th scope="col" class="bg-verde-oscuro borde">Razón Social</th>
                      <th scope="col" class="bg-redbull-celeste borde text-center">250 REGULAR O<br>SUGAR FREE O ZERO</th>
                      <th scope="col" class="bg-redbull-azul borde text-center">CANTIDAD SABORES</th>
                  </tr>
                </thead>
                <tbody style="vertical-align: middle !important;">
                  <?php foreach($detalles as $detalle){ 
                      $class_250 = ($detalle->ROMBO_250 == 'SI') ? 'txt-redbull-celeste' : 'txt-redbull-rojo';
                      $class_003 = ($detalle->CANTIDAD_SABORES == 'SI') ? 'txt-redbull-azul' : 'txt-redbull-azul';
                  ?>
                  <tr>
                      ...
                      <td class="<?= $class_250; ?>"><?= $detalle->ROMBO_250; ?></td>
                      <td class="<?= $class_003; ?>"><?= $detalle->CANTIDAD_SABORES; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
              </table>
