                    ...
                    <th scope="col" class="transparent">
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-azul borde" style="height: 60px;padding-top: 0px;"> 
                          <div class="titulo">
                            <div class="space-10"></div>
                            <div class="text-small">CUMPLIMENTO VOL<br>KUNSTMANN</div>
                          </div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
              ...
              <tbody>
                ...
                foreach($registros as $registro){ 
                 ...
                 <tr>
                    ...
                    <td width="150" class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_VOL_KUNSTMANN; ?></td>
                    <td width="150" class="txt-redbull-rojo"><?= $registro->CUPONES; ?></td>
