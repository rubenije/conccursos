              ...
              <table class="table table-spacing mx-auto tableDetalles pt-2 pb-3 w-100">
                <thead>
                  <tr style="vertical-align: middle !important;">
                      ...
                      <?php if($isMayorista){ ?>
                      <th scope="col" class="bg-azul borde text-center">VOLUMEN VS<br>AA BEP</th>
                      <?php }else{ ?>
                      <th scope="col" class="bg-azul borde text-center">CONCRETADO<br>BEP</th>
                      <?php } ?>
                  </tr>
                </thead>
                <tbody style="vertical-align: middle !important;">
                  <?php foreach($detalles as $detalle){ 
                      $class01 = ($detalle->CONC_BEP == 'SI') ? 'txt-azul' : 'txt-rojo';
                  ?>
                  <tr>
                      ...
                      <?php if($isMayorista){ ?>
                      <td class="<?= $class; ?>"><?= $detalle->VOL_VS_AA_BEP; ?></td>
                      <?php }else{ ?>
                      <td class="<?= $class01; ?>"><?= $detalle->CONC_BEP; ?></td>
                      <?php } ?>
                    </tr>
                    <?php } ?>
                </tbody>
