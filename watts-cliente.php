              ...
              <table class="table table-spacing mx-auto tableDetalles pt-2 pb-3">
                <thead>
                  <tr style="vertical-align: middle !important;">
                      ...
                      <?php if(!$isMayorista){ ?>
                      <th scope="col" class="bg-azul borde text-center">CONCRETADO NARANJA</th>
                      <th scope="col" class="bg-azul borde text-center">CONCRETADO PIÑA</th>
                      <th scope="col" class="bg-azul borde text-center">CONCRETADO DURAZNO</th>
                      <th scope="col" class="bg-azul borde text-center">CONCRETADO TUTIFRUTILLA</th>
                      <th scope="col" class="bg-azul borde text-center">CONCRETADO LIGHT</th>
                      <?php }else{  ?>
                      <th scope="col" class="bg-azul borde text-center">VOLUMEN VS AA NARANJA</th>
                      <th scope="col" class="bg-azul borde text-center">VOLUMEN VS AA PIÑA</th>
                      <th scope="col" class="bg-azul borde text-center">VOLUMEN VS AA DURAZNO</th>
                      <th scope="col" class="bg-azul borde text-center">VOLUMEN VS AA TUTIFRUTILLA</th>
                      <th scope="col" class="bg-azul borde text-center">VOLUMEN VS AA LIGHT</th>
                      <?php } ?>
                  </tr>
                </thead>
                <tbody style="vertical-align: middle !important;">
                  ...
                  <tr>
                      ...
                      <?php if(!$isMayorista){ 
                        ...
                        $class01 = ($detalle->CONCRETADO_NARANJA == 'NO') ? 'txt-rojo' : 'txt-azul';
                        $class02 = ($detalle->CONCRETADO_PINA == 'NO') ? 'txt-rojo' : 'txt-azul';
                        $class03 = ($detalle->CONCRETADO_DURAZNO == 'NO') ? 'txt-rojo' : 'txt-azul';
                        $class04 = ($detalle->CONCRETADO_TUTIFRUTILLA == 'NO') ? 'txt-rojo' : 'txt-azul';
                        $class05 = ($detalle->CONCRETADO_LIGHT == 'NO') ? 'txt-rojo' : 'txt-azul';

                      ?>
                      <td class="<?= $class01; ?>"><?= $detalle->CONCRETADO_NARANJA; ?></td>
                      <td class="<?= $class02; ?>"><?= $detalle->CONCRETADO_PINA; ?></td>
                      <td class="<?= $class03; ?>"><?= $detalle->CONCRETADO_DURAZNO; ?></td>
                      <td class="<?= $class04; ?>"><?= $detalle->CONCRETADO_TUTIFRUTILLA; ?></td>
                      <td class="<?= $class05; ?>"><?= $detalle->CONCRETADO_LIGHT; ?></td>
                      <?php }else{  

                        $class06 = ($detalle->VOL_VS_AA_NARANJA == 'NO') ? 'txt-rojo' : 'txt-azul';
                        $class07 = ($detalle->VOL_VS_AA_PINA == 'NO') ? 'txt-rojo' : 'txt-azul';
                        $class08 = ($detalle->VOL_VS_AA_DURAZNO == 'NO') ? 'txt-rojo' : 'txt-azul';
                        $class09 = ($detalle->VOL_VS_AA_TUTIFRUTILLA == 'NO') ? 'txt-rojo' : 'txt-azul';
                        $class10 = ($detalle->VOL_VS_AA_LIGHT == 'NO') ? 'txt-rojo' : 'txt-azul';  
                      ?>
                      <td class="<?= $class06; ?>"><?= $detalle->VOL_VS_AA_NARANJA; ?></td>
                      <td class="<?= $class07; ?>"><?= $detalle->VOL_VS_AA_PINA; ?></td>
                      <td class="<?= $class08; ?>"><?= $detalle->VOL_VS_AA_DURAZNO; ?></td>
                      <td class="<?= $class09; ?>"><?= $detalle->VOL_VS_AA_TUTIFRUTILLA; ?></td>
                      <td class="<?= $class10; ?>"><?= $detalle->VOL_VS_AA_LIGHT; ?></td>
                      <?php } ?>
                    </tr>
                    <?php } ?>
                </tbody>
