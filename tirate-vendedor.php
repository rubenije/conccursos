              ...
              <table class="table table-spacing mx-auto">
                  ...
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-azul borde" style="height: 60px;padding-top: 0px;"> 
                          <div class="titulo">
                            <div class="space-10"></div>
                            <div class="text-small">Faltan<br>Duo</div>
                          </div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-celeste borde" style="height: 60px;padding-top: 0px;"> 
                          <div class="titulo">
                            <div class="space-10"></div>
                            <div class="text-small">Faltan<br>Manantial</div>
                          </div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-rojo borde" style="height: 60px;padding-top: 10px;">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td width="100" class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_DUO; ?></td>
                      <td width="100" class="txt-redbull-azul"><?= $registro->CUANTOS_FALTAN_DUO; ?></td>
                      <td width="100" class="txt-redbull-celeste"><?= $registro->CUMPLIMIENTO_MANANTIAL; ?></td>
                      <td width="100" class="txt-redbull-celeste"><?= $registro->CUANTOS_FALTAN_MANANTIAL; ?></td>
                      <td width="120"><a href="<?= $table; ?>-cliente.php?id=<?= $registro->id; ?>&tipo=vendedor" class="txt-redbull-rojo"><?= $registro->CUMPLIMIENTO_TOTAL; ?></a></td>
                    </tr>
                    <?php 
                    ...
                    <tr class="transparent">
                      ...
                      <td class="bg-redbull-azul"><?= $total->CUMPLIMIENTO_DUO; ?></td>
                      <td class="bg-redbull-azul"><?= $total->CUANTOS_FALTAN_DUO; ?></td>
                      <td class="bg-redbull-celeste"><?= $total->CUMPLIMIENTO_MANANTIAL; ?></td>
                      <td class="bg-redbull-celeste"><?= $total->CUANTOS_FALTAN_MANANTIAL; ?></td>
                      <td class="bg-redbull-rojo"><?= $total->CUMPLIMIENTO_TOTAL; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
              </table>
            ...
            <div class="is-mobile">
                ...
                <thead>
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-celeste borde" style="height: 60px;">
                          <div class="space-5"></div>
                          <div class="text-small">Faltan Manantial</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent" >
                ...
                <tbody style="vertical-align: middle !important;">
                    ...
                    <tr>
                      ...
                      <td class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_DUO; ?></td>
                      <td class="txt-redbull-azul"><?= $registro->CUANTOS_FALTAN_DUO; ?></td>
                      <td class="txt-redbull-celeste"><?= $registro->CUMPLIMIENTO_MANANTIAL; ?></td>
                      <td class="txt-redbull-celeste"><?= $registro->CUANTOS_FALTAN_MANANTIAL; ?></td>
                      <td ><a href="<?= $table; ?>-cliente.php?id=<?= $registro->id; ?>&tipo=vendedor" class="txt-redbull-rojo"><?= $registro->CUMPLIMIENTO_TOTAL; ?></a></td>
                    </tr>
                    <?php 
                      $totIngresos += $ingresos;
                      } ?>
