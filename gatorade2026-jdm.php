                ...
                <tr>
                  ...
                  <th scope="col" class="transparent">
                    <div class="titulo bg-rojo borde">
                        <div class="space-5"></div>
                        <div class="text-small">CUMPLIMIENTO<br>ACELERADOR 2 DE 1LT + 750</div>
                    </div>
                  </th>
                </tr>
              </thead>
              ...
              <tbody>
                ...
                ?>
                 <tr>
                    ...
                    <td style="width: 120px;" class="txt-azul"><?= $distrito->CUMPLIMIENTO_HORIZONTAL; ?></td>
                    <td style="width: 120px;" class="txt-rojo"><?= $distrito->CUMPLIMIENTO_ACELERADOR_750_1LT; ?></td>
                  </tr>
                <?php } ?>
                  <tr class="bg-verde-oscuro fw-bold">
                    ...
                    <td class="bg-azul"><?= $subtotal->CUMPLIMIENTO_HORIZONTAL; ?></td>
                    <td class="bg-rojo"><?= $subtotal->CUMPLIMIENTO_ACELERADOR_750_1LT; ?></td>
                  </tr>
              </tbody>
              <?php } 
            ...
            <table class="table table-spacing totales mx-auto">
              <tbody>
                  <tr class="bg-verde-oscuro">
                    ...
                    <td style="width: 120px;" class="bg-azul"><?= $totales->CUMPLIMIENTO_HORIZONTAL; ?></td>
                    <td style="width: 120px;" class="bg-rojo"><?= $totales->CUMPLIMIENTO_ACELERADOR_750_1LT; ?></td>
                  </tr>
              </tbody>
            </table>
            <?php } ?>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td class="txt-azul"><?= $distrito->CUMPLIMIENTO_HORIZONTAL; ?></td>
                    <td class="txt-rojo"><?= $distrito->CUMPLIMIENTO_ACELERADOR_750_1LT; ?></td>
                  </tr>
                <?php } ?>
                  <tr class="bg-verde-oscuro fw-bold">
                    <td class="text-start bg-verde-oscuro">Total Zona Norte</td>
            ...
            ?>
                <?php if($totales){ ?>
                  <tr class="bg-verde-oscuro">
                    ...
                    <td class="bg-azul"><?= $totales->CUMPLIMIENTO_HORIZONTAL; ?></td>
                    <td class="bg-rojo"><?= $totales->CUMPLIMIENTO_ACELERADOR_750_1LT; ?></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
