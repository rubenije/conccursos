              ...
              <table class="table table-spacing mx-auto">
                <thead>
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde" style="height: 60px;padding-top: 0px;"> 
                            <div class="space-15"></div>
                            <div class="text-small">FALTANTES<br>DUO</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                      ...
                      <th scope="col" class="transparent">
                        <div class="titulo bg-celeste borde" style="height: 60px;padding-top: 0px;"> 
                            <div class="space-15"></div>
                            <div class="text-small">FALTANTES<br>MANANTIAL</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td width="150" class="txt-azul"><?= $registro->CUMPLIMIENTO_DUO; ?></td>
                      <td width="150" class="txt-azul"><?= $registro->FALTANTES_DUO; ?></td>
                      <td width="150" class="txt-celeste"><?= $registro->CUMPLIMIENTO_MANANTIAL; ?></td>
                      <td width="150" class="txt-celeste"><?= $registro->FALTANTES_MANANTIAL; ?></td>
                    ...
                    <tr class="transparent">
                      ...
                      <td class="bg-azul"><?= $total->CUMPLIMIENTO_DUO; ?></td>
                      <td class="bg-celeste"><?= $total->CUMPLIMIENTO_MANANTIAL; ?></td>
                      <td class="bg-rojo">&nbsp;</td>
                    </tr>
                    <?php } ?>
                </tbody>
            ...
            <div class="is-mobile">
                  ...
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde" style="height: 60px;">
                            <div class="space-15"></div>
                            <div class="text-small">CUMP DUO</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde" style="height: 60px;">
                            <div class="space-15"></div>
                            <div class="text-small">FALTANTES DUO</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-celeste borde" style="height: 60px;">
                            <div class="space-15"></div>
                            <div class="text-small">CUMP MANANTIAL</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-celeste borde" style="height: 60px;">
                            <div class="space-15"></div>
                            <div class="text-small">FALTANTES MANANTIAL</div>
                        </div>
                      </th>
                ...
                <tbody style="vertical-align: middle !important;">
                    ...
                    <tr>
                      ...
                      <td class="txt-azul"><?= $registro->CUMPLIMIENTO_DUO; ?></td>
                      <td class="txt-azul"><?= $registro->FALTANTES_DUO; ?></td>
                      <td class="txt-celeste"><?= $registro->CUMPLIMIENTO_MANANTIAL; ?></td>
                      <td class="txt-celeste"><?= $registro->FALTANTES_MANANTIAL; ?></td>
                    ...
                    <tr class="transparent">
                      ...
                      <td class="bg-amarillo"><?= $totIngresos; ?></td>
                      <td class="bg-azul"><?= $total->CUMPLIMIENTO_DUO; ?></td>
                      <td class="bg-azul"><?= $total->FALTANTES_DUO; ?></td>
                      <td class="bg-celeste"><?= $total->CUMPLIMIENTO_MANANTIAL; ?></td>
                      <td class="bg-celeste"><?= $total->FALTANTES_MANANTIAL; ?></td>
                      <td class="bg-rojo">&nbsp;</td>
                    </tr>
                    <?php } ?>
                    <tr class="transparent">
