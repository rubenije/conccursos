              ...
              <tbody>
                ...
                foreach($registros as $registro){ 
                 ...
                 <tr>
                    ...
                    <td width="120" class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_DUO; ?></td>
                    <td width="120" class="txt-redbull-azul"><?= $registro->CUANTOS_FALTAN_DUO; ?></td>
                    <td width="120" class="txt-redbull-celeste"><?= $registro->CUMPLIMIENTO_MANANTIAL; ?></td>
                    <td width="120" class="txt-redbull-celeste"><?= $registro->CUANTOS_FALTAN_MANANTIAL; ?></td>
                    <td width="100" class="txt-redbull-rojo"><?= $registro->CUMPLIMIENTO_TOTAL; ?></td>
                  </tr>
                  <?php 
            ...
            <tbody>
              <?php 
                ...
                <tr>
                  ...
                  <td class="txt-redbull-rojo"><?= $registro->CUMPLIMIENTO_TOTAL; ?></td>
                </tr>
                <?php 
                $totIngresos += $ingresos;
                } ?>
