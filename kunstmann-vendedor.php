              ...
              <table class="table table-spacing mx-auto">
                  ...
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-azul borde" style="height: 60px;padding-top: 0px;"> 
                          <div class="titulo">
                            <div class="space-10"></div>
                            <div class="text-small">CUMPLIMIENTO<br>VOL KUNSTMANN</div>
                          </div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-rojo borde" style="height: 60px;padding-top: 0px;"> 
                          <div class="titulo">
                            <div class="space-10"></div>
                            <div class="text-small">CUPONES</div>
                          </div>
                        </div>
                      </th>
                      <?php } ?>
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td width="100" class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_VOL_KUNSTMANN; ?></td>
                      <td width="100" class="txt-redbull-azul"><?= $registro->HL_FALTANTES; ?></td>
                      <td width="100" class="txt-redbull-rojo"><?= $registro->CUPONES; ?></td>
                    ...
                    <tr class="transparent">
                      ...
                      <td class="bg-redbull-azul"><?= $total->CUMPLIMIENTO_VOL_KUNSTMANN; ?></td>
                      <td class="bg-redbull-azul"><?= $total->HL_FALTANTES; ?></td>
                      <td class="bg-redbull-rojo"><?= $total->CUPONES; ?></td>
            ...
            <div class="is-mobile">
                  ...
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-azul borde" style="height: 60px;">
                          <div class="titulo">
                            <div class="space-5"></div>
                            <div class="text-small">HL Faltantes<br></div>
                          </div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                ...
                <tbody style="vertical-align: middle !important;">
                    ...
                    <tr>
                      ...
                      <td class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_VOL_KUNSTMANN; ?></td>
                      <td class="txt-redbull-azul"><?= $registro->HL_FALTANTES; ?></td>
                      <td class="txt-redbull-rojo"><?= $registro->CUPONES; ?></td>
