              ...
              <table class="table table-spacing mx-auto">
                <thead>
                  <tr>
                      ...
                      <?php if($isMayorista){ ?>
                      <th scope="col" class="transparent">
                        <div class="bg-azul borde" style="height: 60px;padding-top: 0px;"> 
                          <div class="titulo">
                            <div class="space-10"></div>
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-rojo borde" style="height: 60px;padding-top: 0px;"> 
                          <div class="titulo">
                            <div class="space-10"></div>
                            <div class="text-small">HL FALTANTES<br>BEP</div>
                          </div>
                        </div>
                      </th>
                      <?php }else{ ?>
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-rojo borde" style="height: 60px;padding-top: 0px;"> 
                          <div class="titulo">
                            <div class="space-10"></div>
                            <div class="text-small">CLIENTES<br>FALTANTES</div>
                          </div>
                        </div>
                      </th>
                      <?php } ?>
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <?php if($isMayorista){ ?>
                      <td width="100" class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_VOL_BEP; ?></td>
                      <td width="100" class="txt-redbull-rojo"><?= $registro->FALTANTE_VOL_BEP; ?></td>
                      <?php }else{ ?>
                      <td width="100" class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_CONC_BEP; ?></td>
                      <td width="100" class="txt-redbull-rojo"><?= $registro->FALTANTE_CONC_BEP; ?></td>
                      <?php } ?>
                    ...
                    <tr class="transparent">
                      ...
                      <?php if($isMayorista){ ?>
                      <td class="bg-azul"><?= $total->CUMPLIMIENTO_VOL_BEP; ?></td>
                      <td class="bg-redbull-rojo"><?= $total->FALTANTE_VOL_BEP; ?></td>
                      <?php }else{ ?>
                      <td class="bg-azul"><?= $total->CUMPLIMIENTO_CONC_BEP; ?></td>
                      <td class="bg-redbull-rojo"><?= $total->FALTANTE_CONC_BEP; ?></td>
                      <?php } ?>
                    </tr>
                    <?php } ?>
                </tbody>
            ...
            <div class="is-mobile">
                  ...
                  <tr>
                      ...
                      <th scope="col" class="transparent">
                        <div class="bg-azul borde" style="height: 60px;">
                          <div class="titulo">
                            <div class="space-5"></div>
                            <div class="text-small">Cumpliemiento<br>BEP</div>
                          </div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="bg-redbull-rojo borde" style="height: 60px;">
                          <div class="titulo">
                            <div class="space-5"></div>
                            <div class="text-small">Faltantes<br>BEP</div>
                          </div>
                        </div>
                      </th>
                      ...
                      <th scope="col" class="transparent" >
                        <div class="titulo bg-rojo borde" style="height: 60px;"> 
                          <div class="space-10"></div>
                          <div class="text-small">DETALLE</div>
                        </div>
                      </th>
                ...
                <tbody style="vertical-align: middle !important;">
                    ...
                    <tr>
                      ...
                      <?php if($isMayorista){ ?>
                      <td class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_VOL_BEP; ?></td>
                      <td class="txt-redbull-rojo"><?= $registro->FALTANTE_VOL_BEP; ?></td>
                      <?php }else{ ?>
                      <td class="txt-redbull-azul"><?= $registro->CUMPLIMIENTO_CONC_BEP; ?></td>
                      <td class="txt-redbull-rojo"><?= $registro->FALTANTE_CONC_BEP; ?></td>
                      <?php } ?>
                    ...
                    <tr class="transparent">
                      ...
                      <td class="bg-rojo">
                        <div class="text-small">
                          Haz click y revisa<br>el estado de tus clientes
                        </div>
                      </td>
                    </tr>
                    <?php } ?>
