          ...
          <div class="col-12 col-lg-8 text-center">
                    ...
                    <th scope="col" class="transparent">
                      ...
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde"> 
                            ...
                            <div class="text-small">CUMPLIMIENTO 3<br>SABORES ROTADORES</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                      ...
                      <th scope="col" class="transparent">
                        <div class="titulo bg-azul borde"> 
                            <div class="space-5"></div>
                            <div class="text-small">CUMPLIMIENTO VOL 3<br>SABORES ROTADORES</div>
                        </div>
                      </th>
                      <th scope="col" class="transparent">
                        <div class="titulo bg-rojo borde"> 
                            <div class="space-5"></div>
                            <div class="text-small">CUMPLIMIENTO VOL<br>ACELERADOR LIGHT</div>
                        </div>
                      </th>
                      <?php } ?>
                </tr>
            ...
            <thead>
              <tr>
                  ...
                  <th scope="col" class="transparent">
                    <div class="titulo bg-azul borde"> 
                      <div class="text-small">Cump Vol<br>3 Sabores R</div>
                    </div>
                  </th>
                  <th scope="col" class="transparent">
                    <div class="titulo bg-rojo borde"> 
                      <div class="text-small">Cump Vol<br>Acelerador Light</div>
                    </div>
                  </th>
                  <?php } ?>
              </tr>
