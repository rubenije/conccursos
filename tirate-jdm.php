<?php   
  ...
  require_once(INCLUDE_PATH.'class/class.zona.php');
  ...
  $objZona  = new zona();
  $zonas    = $objZona->getPublicZonaAll();
                ...
                <tr>
                  ...
                  <th scope="col" class="transparent">
                    <div class="bg-redbull-celeste borde">
                      <div class="titulo">
                        <div class="space-5"></div>
                        <div class="text-small">Cump<br>Manantial</div>
                      </div>
                    </div>
                  </th>
                  <th scope="col" class="transparent">
              ...
              <tbody>
                ...
                ?>
                 <tr>
                    ...
                    <td style="width: 100px;" class="txt-redbull-amarillo"><?= $ingresos; ?></td>
                    <td style="width: 100px;" class="txt-redbull-amarillo"><?= $unicos; ?></td>
                    <td style="width: 120px;" class="txt-redbull-azul"><?= $distrito->CUMPLIMIENTO_DUO; ?></td>
                    <td style="width: 120px;" class="txt-redbull-celeste"><?= $distrito->CUMPLIMIENTO_MANANTIAL; ?></td>
                    <td style="width: 100px;" class="txt-redbull-rojo"><?= $distrito->CUMPLIMIENTO_TOTAL; ?></td>
                  </tr>
                <?php } ?>
                  <tr class="bg-verde-oscuro fw-bold">
                    ...
                    <td class="bg-redbull-azul"><?= $subtotal->CUMPLIMIENTO_DUO; ?></td>
                    <td class="bg-redbull-celeste"><?= $subtotal->CUMPLIMIENTO_MANANTIAL; ?></td>
                    <td class="bg-redbull-rojo"><?= $subtotal->CUMPLIMIENTO_TOTAL; ?></td>
                  </tr>
              </tbody>
              <?php } 
            ...
            <table class="table table-spacing totales mx-auto">
              <tbody>
                  <tr class="bg-verde-oscuro">
                    ...
                    <td style="width: 100px;" class="bg-redbull-amarillo"><?= $totFinalIngresos; ?></td>
                    <td style="width: 100px;" class="bg-redbull-amarillo"><?= $totFinalUnicos; ?></td>
                    <td style="width: 120px;" class="bg-redbull-azul"><?= $totales->CUMPLIMIENTO_DUO; ?></td>
                    <td style="width: 120px;" class="bg-redbull-celeste"><?= $totales->CUMPLIMIENTO_MANANTIAL; ?></td>
                    <td style="width: 100px;" class="bg-redbull-rojo"><?= $totales->CUMPLIMIENTO_TOTAL; ?></td>
                  </tr>
              </tbody>
            </table>
            <?php } ?>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td class="txt-redbull-azul"><?= $distrito->CUMPLIMIENTO_DUO; ?></td>
                    <td class="txt-redbull-celeste"><?= $distrito->CUMPLIMIENTO_MANANTIAL; ?></td>
                    <td class="txt-redbull-rojo"><?= $distrito->CUMPLIMIENTO_TOTAL; ?></td>
                  </tr>
                <?php } ?>
                  <tr class="bg-verde-oscuro fw-bold">
                    <td class="text-start bg-verde-oscuro">Total Zona Norte</td>
            ...
            ?>
                <?php if($totales){ ?>
                  <tr class="bg-verde-oscuro">
                    ...
                    <td class="bg-redbull-azul"><?= $totales->CUMPLIMIENTO_DUO; ?></td>
                    <td class="bg-redbull-celeste"><?= $totales->CUMPLIMIENTO_MANANTIAL; ?></td>
                    <td class="bg-redbull-rojo"><?= $totales->CUMPLIMIENTO_TOTAL; ?></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
