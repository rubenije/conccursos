              ...
              <table class="table table-spacing mx-auto tableDetalles pt-2 pb-3">
                <thead>
                  <tr style="vertical-align: middle !important;">
                      ...
                      <th scope="col" class="bg-amarillo borde text-center">CATUN_1_6</th>
                      <th scope="col" class="bg-amarillo borde text-center">CATUN_2_5</th>
                      <th scope="col" class="bg-verde-claro borde text-center">MANAN_3</th>
                      <th scope="col" class="bg-verde-claro borde text-center">MANAN_1_5</th>
                  </tr>
                </thead>
                <tbody style="vertical-align: middle !important;">
                  <?php foreach($detalles as $detalle){ 
                      $class_1_6 = ($detalle->CATUN_1_6 == 'SI') ? 'txt-azul' : 'txt-azul';
                      $class_2_5 = ($detalle->CATUN_2_5 == 'SI') ? 'txt-azul' : 'txt-azul';
                      $class_3 = ($detalle->MANAN_3 == 'SI') ? 'txt-azul' : 'txt-azul';
                      $class_1_5 = ($detalle->MANAN_1_5 == 'SI') ? 'txt-azul' : 'txt-azul';
                  ?>
                  <tr>
                      ...
                      <td class="<?= $class_1_6; ?>"><?= $detalle->CATUN_1_6; ?></td>
                      <td class="<?= $class_2_5; ?>"><?= $detalle->CATUN_2_5; ?></td>
                      <td class="<?= $class_3; ?>"><?= $detalle->MANAN_3; ?></td>
                      <td class="<?= $class_1_5; ?>"><?= $detalle->MANAN_1_5; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
              </table>
